...
call %msbuild% %cd%\Configuration.EntityFramework\Configuration.EntityFramework.csproj /p:Configuration="%config%" /m /v:M /fl /flp:LogFile=msbuild.log;Verbosity=Normal /nr:false
