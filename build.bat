...
"%programfiles(x86)%\MSBuild\15.0\Bin\MSBuild.exe" src\Configuration.EntityFramework.sln /p:Configuration="%config%" /m /v:M /fl /flp:LogFile=msbuild.log;Verbosity=Normal /nr:false
