...
namespace Configuration.EntityFramework.Tests
{
    public class SectionEntityTests : IClassFixture<DbContextFixture>
    {
        ...
        public void Given_AddSection_When_IsValid_Then_SectionPersisted()
        {
            ...
            context.Sections.Add(new SectionEntity() { Tenant = Guid.NewGuid(), ApplicationName = "DbContextSectionTests", SectionName = "appSettings", Aspect = "Application", Discriminator = @"{""Environment"":""Testing"", ""Username"":""Patrick""}", ModifiedUser = "TestUser" });
            context.SaveChanges();
            Assert.NotNull(context.Sections.AsNoTracking().FirstOrDefault(s => s.ApplicationName == "DbContextSectionTests" && s.SectionName == "appSettings" && s.Aspect == "Application"));
        }
        ...
        public void Given_AddSection_When_ApplicationNameIsNotValid_Then_SectionNotPersisted()
        {
            ...
            {
                context.Sections.Add(new SectionEntity() { Tenant = Guid.NewGuid(), ApplicationName = null, SectionName = "appSettings", Aspect = "Application", ModifiedUser = "TestUser" });
                context.SaveChanges();
            });
        ...
        public void Given_AddSection_When_SectionNameIsNotValid_Then_SectionNotPersisted()
        {
            ...
            var exception = Assert.Throws<DbUpdateException>(() =>
            {
                context.Sections.Add(new SectionEntity() { ApplicationName = "DbContextSectionTests", SectionName = null, Aspect = "Application", ModifiedUser = "TestUser" });
                context.SaveChanges();
            });
        ...
        //    var exception = Assert.Throws<DbUpdateException>(() =>
        //    {
        //        context.Sections.Add(new SectionEntity() { ApplicationName = "DbContextSectionTests.Duplicate", SectionName = "appSettingsC", Aspect = "Application", ModifiedUser = "TestUser" });
        //        context.Sections.Add(new SectionEntity() { ApplicationName = "DbContextSectionTests.Duplicate", SectionName = "appSettingsC", Aspect = "Application", ModifiedUser = "TestUser" });
        //        context.SaveChanges();
        //    });
